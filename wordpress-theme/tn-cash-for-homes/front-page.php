    ...
    <div class="reviews-outer" id="reviewsOuter">
      <div class="reviews-track" id="reviewsTrack">
        ...
        <div class="reviews-slide">
          <div class="testimonial-card">
            <div class="testimonial-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
            <p class="testimonial-body">They bought my father's rental portfolio! Paid cash and closed on multiple homes in less than 3 weeks. Incredibly smooth from start to finish &mdash; would not hesitate to work with them again.</p>
            <div class="testimonial-author">
        ...
        <div class="reviews-slide">
          ...
          <div class="testimonial-card">
            <div class="testimonial-stars">&#9733;&#9733;&#9733;&#9733;&#9733;</div>
            <p class="testimonial-body">Love these guys. They are the very best to sell your property to in <a href="<?php echo esc_url( home_url( '/where-we-buy/nashville/' ) ); ?>" class="city-link">Nashville</a>, TN. Thank you!</p>
            <div class="testimonial-author">
