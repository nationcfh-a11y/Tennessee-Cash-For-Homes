 ...
 * City location page for Chattanooga, TN
 *
...
<!-- ── LOCATION HERO ── -->
<section class="location-hero" style="background-image: url('<?php echo get_template_directory_uri(); ?>/brand_assets/Where%20We%20Buy%20Pages/Where%20We%20Buy%20Images/Chattanooga.webp');">
  ...
  <div class="container">
    <div class="location-hero__inner">
      <div class="location-hero__content">
        ...
        <div class="hero__badge">Chattanooga Cash Home Buyers</div>
        <h1 class="location-hero__title">Sell Your House For Cash In Chattanooga</h1>
        <p class="location-hero__subtitle">No repairs. No commissions. No fees. Get a fair cash offer for your Chattanooga home in as little as 24 hours. We close on your timeline.</p>
      ...
      <div class="hero__form-card" id="get-offer">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="loc-address-chattanooga">Property Address</label>
            <input type="text" id="loc-address-chattanooga" name="address" placeholder="123 Main St, Chattanooga, TN" required />
          </div>
          <div class="form-group">
            <label for="loc-name-chattanooga">Your Name</label>
            <input type="text" id="loc-name-chattanooga" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="loc-phone-chattanooga">Phone Number</label>
            <input type="tel" id="loc-phone-chattanooga" name="phone" placeholder="(615) 555-0123" required />
          </div>
  ...
  <div class="container">
    <div class="loc-about__inner">
      <div class="loc-about__content">
        <p class="section__eyebrow">We Buy Houses in Chattanooga</p>
        <h2 class="section__title">Sell Your Chattanooga House Fast for Cash</h2>
        <p class="loc-about__body">Chattanooga is known for its outdoor beauty and fast-growing urban core. Whether you're downsizing, relocating, or facing financial difficulties, Tennessee Cash For Homes is ready to make a fair offer on your Chattanooga property. We buy homes in any condition, from fixer-uppers to move-in ready homes. Our streamlined process means you won't have to deal with listing your property, hosting open houses, or waiting months for a buyer. We're committed to making your home-selling experience in Chattanooga as smooth and quick as possible.</p>
        <p class="loc-about__body">Chattanooga's growth and desirability mean opportunities for homeowners to sell — but sometimes you need to sell fast. Tennessee Cash For Homes is here to ensure you can sell your home quickly in Chattanooga without sacrificing value. We offer fair cash prices based on the current market and the condition of your property. Our team handles everything from the initial offer to closing, ensuring a stress-free and efficient process for you. Trust us to provide you with the best possible service, making your home sale in Chattanooga seamless and swift.</p>
        <a href="#get-offer" class="btn-primary">Get My Free Cash Offer &rarr;</a>
      </div>
  ...
  <div class="container land-section__inner">
    ...
    <div class="land-section__form-wrap">
      <div class="hero__form-card">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="land-address-chattanooga">Property Address</label>
            <input type="text" id="land-address-chattanooga" name="address" placeholder="123 Acres Rd, Chattanooga, TN" required />
          </div>
          <div class="form-group">
            <label for="land-name-chattanooga">Your Name</label>
            <input type="text" id="land-name-chattanooga" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="land-phone-chattanooga">Phone Number</label>
            <input type="tel" id="land-phone-chattanooga" name="phone" placeholder="(615) 555-0123" required />
          </div>
          <button type="submit" class="btn-primary btn-primary--block">Get My Cash Offer &rarr;</button>
        </form>
        <p class="form-disclaimer">&#128274; Your info is private and never shared.</p>
...
<section class="cta-band">
  <div class="container">
    <h2>Ready to Sell Your Chattanooga House Fast for Cash?</h2>
