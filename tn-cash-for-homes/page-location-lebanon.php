 ...
 * City location page for Lebanon, TN
 *
...
<!-- ── LOCATION HERO ── -->
<section class="location-hero" style="background-image: url('<?php echo get_template_directory_uri(); ?>/brand_assets/Where%20We%20Buy%20Pages/Where%20We%20Buy%20Images/Lebanon.webp');">
  ...
  <div class="container">
    <div class="location-hero__inner">
      <div class="location-hero__content">
        ...
        <div class="hero__badge">Lebanon Cash Home Buyers</div>
        <h1 class="location-hero__title">Sell Your House For Cash In Lebanon</h1>
        <p class="location-hero__subtitle">No repairs. No commissions. No fees. Get a fair cash offer for your Lebanon home in as little as 24 hours. We close on your timeline.</p>
      ...
      <div class="hero__form-card" id="get-offer">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="loc-address-lebanon">Property Address</label>
            <input type="text" id="loc-address-lebanon" name="address" placeholder="123 Main St, Lebanon, TN" required />
          </div>
          <div class="form-group">
            <label for="loc-name-lebanon">Your Name</label>
            <input type="text" id="loc-name-lebanon" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="loc-phone-lebanon">Phone Number</label>
            <input type="tel" id="loc-phone-lebanon" name="phone" placeholder="(615) 555-0123" required />
          </div>
  ...
  <div class="container">
    <div class="loc-about__inner">
      <div class="loc-about__content">
        <p class="section__eyebrow">We Buy Houses in Lebanon</p>
        <h2 class="section__title">Sell Your Lebanon House Fast for Cash</h2>
        <p class="loc-about__body">Lebanon is known for its small-town feel and proximity to Nashville, making it a desirable location for home sellers. If you're looking to sell your house for cash in Lebanon, Tennessee Cash For Homes provides an easy and efficient process. We buy homes in Lebanon in any condition, which means you won't need to spend money on repairs or renovations. Our team offers fair cash offers and a streamlined process to ensure you can sell your Lebanon home quickly and without stress.</p>
        <p class="loc-about__body">In Lebanon, where community and convenience meet, Tennessee Cash For Homes helps homeowners sell their properties swiftly and without hassle. Whether you are looking to sell quickly due to financial reasons, relocation, or personal circumstances, we have the expertise and resources to help. We provide fair cash offers that take into account the condition and market value of your home, ensuring that you get the best possible deal. Our team handles all the details, from offer to closing, so you can focus on what matters most.</p>
        <a href="#get-offer" class="btn-primary">Get My Free Cash Offer &rarr;</a>
      </div>
...
<section class="land-section">
  ...
  <div class="container land-section__inner">
    <div class="land-section__content">
      <p class="section__eyebrow land-section__eyebrow">Lebanon Land Buyers</p>
      <h2 class="land-section__title">Sell Your Land in Lebanon for Cash</h2>
      <p class="land-section__body">Lebanon's location along I-40 and its expanding suburban communities make it a hotspot for residential and commercial growth. With new developments constantly rising, landowners in Lebanon have strong selling opportunities — but navigating the land market alone can be slow and complicated. Tennessee Cash For Homes offers a simple, fast solution for selling land in Lebanon for cash, bypassing agents, commissions, and months of waiting.</p>
    ...
    <div class="land-section__form-wrap">
      <div class="hero__form-card">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="land-address-lebanon">Property Address</label>
            <input type="text" id="land-address-lebanon" name="address" placeholder="123 Acres Rd, Lebanon, TN" required />
          </div>
          <div class="form-group">
            <label for="land-name-lebanon">Your Name</label>
            <input type="text" id="land-name-lebanon" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="land-phone-lebanon">Phone Number</label>
            <input type="tel" id="land-phone-lebanon" name="phone" placeholder="(615) 555-0123" required />
          </div>
          <button type="submit" class="btn-primary btn-primary--block">Get My Cash Offer &rarr;</button>
        </form>
        <p class="form-disclaimer">&#128274; Your info is private and never shared.</p>
...
<section class="cta-band">
  <div class="container">
    <h2>Ready to Sell Your Lebanon House Fast for Cash?</h2>
