<?php
/**
 * County Map Hero Component
 *
 * Renders a small Tennessee SVG map with a specific county highlighted in green.
 *
 * Required variables:
 *   $county_id   — the SVG path id (lowercase, e.g. 'davidson', 'rutherford')
 *   $county_name — display name for the label (e.g. 'Davidson County')
 */

$county_id   = isset( $county_id )   ? $county_id   : '';
$county_name = isset( $county_name ) ? $county_name : '';
?>
...
<div class="county-map-hero-wrap">
  <div class="county-map-hero-svg">
    <svg viewBox="1.32 0.99 88.28 23.64" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" aria-label="Tennessee county map highlighting <?php echo esc_attr( $county_name ); ?>" role="img">
      <g transform="matrix(1, 0.11538, 0, 1, 0, -10.0385)">
        ...
        <g class="county-group" data-county="Franklin" data-slug="franklin-county">
          <path class="county-path" id="franklin-co" d="m 43.745059,24.472401 0.005,-0.055 0.099,-0.104 0.947,-0.333 1.277,0.118 1.351,0.572 0.514,0.798 0.419,3.024 -4.675,0.455 -0.079,0.004 -0.173,-1.758 0.315,-2.721" fill="#E8E8E8" stroke="#FFFFFF" stroke-width="0.12" stroke-linejoin="round"><title>Franklin County</title></path>
        </g>
  ...
  <?php if ( $county_name ) : ?>
  <div class="county-map-label"><?php echo esc_html( $county_name ); ?></div>
  <?php endif; ?>
</div>
