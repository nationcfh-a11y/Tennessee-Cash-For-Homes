<?php
/**
 * Shared stats strip partial.
 * Single source of truth — matches the homepage stats strip exactly.
 * Loaded on every applicable template via get_template_part('stats-strip').
 */
?>
<!-- ── PROOF BAR ── -->
<div class="proof-bar">
