 ...
 * City location page for Spring Hill, TN
 *
...
<!-- ── LOCATION HERO ── -->
<section class="location-hero" style="background-image: url('<?php echo get_template_directory_uri(); ?>/brand_assets/Where%20We%20Buy%20Pages/Where%20We%20Buy%20Images/Spring%20Hill.webp');">
  ...
  <div class="container">
    <div class="location-hero__inner">
      <div class="location-hero__content">
        ...
        <div class="hero__badge">Spring Hill Cash Home Buyers</div>
        <h1 class="location-hero__title">Sell Your House For Cash In Spring Hill</h1>
        <p class="location-hero__subtitle">No repairs. No commissions. No fees. Get a fair cash offer for your Spring Hill home in as little as 24 hours. We close on your timeline.</p>
      ...
      <div class="hero__form-card" id="get-offer">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="loc-address-spring-hill">Property Address</label>
            <input type="text" id="loc-address-spring-hill" name="address" placeholder="123 Main St, Spring Hill, TN" required />
          </div>
          <div class="form-group">
            <label for="loc-name-spring-hill">Your Name</label>
            <input type="text" id="loc-name-spring-hill" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="loc-phone-spring-hill">Phone Number</label>
            <input type="tel" id="loc-phone-spring-hill" name="phone" placeholder="(615) 555-0123" required />
          </div>
  ...
  <div class="container">
    <div class="loc-about__inner">
      <div class="loc-about__content">
        <p class="section__eyebrow">We Buy Houses in Spring Hill</p>
        <h2 class="section__title">Sell Your Spring Hill House Fast for Cash</h2>
        <p class="loc-about__body">Spring Hill's proximity to Nashville and family-friendly atmosphere makes it an attractive market for real estate. If you're asking, "How do I sell my Spring Hill home fast for cash?" Tennessee Cash For Homes has the answer. We offer competitive cash offers that provide a fast alternative to the traditional home-selling process. Our team is experienced in handling a wide range of properties and is committed to providing you with the best possible service, ensuring a quick and stress-free transaction.</p>
        <p class="loc-about__body">Spring Hill's thriving community is an excellent place for families, but when it's time to sell quickly, Tennessee Cash For Homes is your go-to resource. We make it easy to sell your Spring Hill home fast by providing fair cash offers that reflect the market value of your property. Our process is simple and transparent, with no hidden fees or complications. Whether you're relocating, downsizing, or dealing with a difficult property situation, we're here to help you sell your home quickly and efficiently.</p>
        <a href="#get-offer" class="btn-primary">Get My Free Cash Offer &rarr;</a>
      </div>
  ...
  <div class="container land-section__inner">
    ...
    <div class="land-section__form-wrap">
      <div class="hero__form-card">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="land-address-spring-hill">Property Address</label>
            <input type="text" id="land-address-spring-hill" name="address" placeholder="123 Acres Rd, Spring Hill, TN" required />
          </div>
          <div class="form-group">
            <label for="land-name-spring-hill">Your Name</label>
            <input type="text" id="land-name-spring-hill" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="land-phone-spring-hill">Phone Number</label>
            <input type="tel" id="land-phone-spring-hill" name="phone" placeholder="(615) 555-0123" required />
          </div>
          <button type="submit" class="btn-primary btn-primary--block">Get My Cash Offer &rarr;</button>
        </form>
        <p class="form-disclaimer">&#128274; Your info is private and never shared.</p>
...
<section class="cta-band">
  <div class="container">
    <h2>Ready to Sell Your Spring Hill House Fast for Cash?</h2>
