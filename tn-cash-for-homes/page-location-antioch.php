 ...
 * City location page for Antioch, TN
 *
...
<!-- ── LOCATION HERO ── -->
<section class="location-hero" style="background-image: url('<?php echo get_template_directory_uri(); ?>/brand_assets/Where%20We%20Buy%20Pages/Where%20We%20Buy%20Images/Antioch.webp');">
  ...
  <div class="container">
    <div class="location-hero__inner">
      <div class="location-hero__content">
        ...
        <div class="hero__badge">Antioch Cash Home Buyers</div>
        <h1 class="location-hero__title">Sell Your House For Cash In Antioch</h1>
        <p class="location-hero__subtitle">No repairs. No commissions. No fees. Get a fair cash offer for your Antioch home in as little as 24 hours. We close on your timeline.</p>
      ...
      <div class="hero__form-card" id="get-offer">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="loc-address-antioch">Property Address</label>
            <input type="text" id="loc-address-antioch" name="address" placeholder="123 Main St, Antioch, TN" required />
          </div>
          <div class="form-group">
            <label for="loc-name-antioch">Your Name</label>
            <input type="text" id="loc-name-antioch" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="loc-phone-antioch">Phone Number</label>
            <input type="tel" id="loc-phone-antioch" name="phone" placeholder="(615) 555-0123" required />
          </div>
  ...
  <div class="container">
    <div class="loc-about__inner">
      <div class="loc-about__content">
        <p class="section__eyebrow">We Buy Houses in Antioch</p>
        <h2 class="section__title">Sell Your Antioch House Fast for Cash</h2>
        <p class="loc-about__body">Antioch is a growing suburb of Nashville, ideal for homeowners looking for a quick sale. If you need to sell your house in Antioch fast, Tennessee Cash For Homes offers a simple solution. We provide Antioch homeowners with fair cash offers allowing you to bypass the traditional market and sell your home in a fraction of the time. We are experienced in handling all types of properties, ensuring a seamless and stress-free transaction. We've helped many Antioch residents sell their homes quickly and without complications.</p>
        <p class="loc-about__body">In Antioch, take advantage of our expertise at Tennessee Cash For Homes to sell your home quickly and efficiently. We understand the pressures you might face, from financial constraints to the need for a quick relocation. Our team is equipped to handle any situation, offering you the resources and support needed to sell your Antioch home fast. With our straightforward process and commitment to transparency, you can trust us to guide you every step of the way, ensuring a quick and satisfactory sale.</p>
        <a href="#get-offer" class="btn-primary">Get My Free Cash Offer &rarr;</a>
      </div>
...
<section class="land-section">
  ...
  <div class="container land-section__inner">
    <div class="land-section__content">
      <p class="section__eyebrow land-section__eyebrow">Antioch Land Buyers</p>
      <h2 class="land-section__title">Sell Your Land in Antioch for Cash</h2>
      <p class="land-section__body">Antioch's rapid development has created a high demand for residential and commercial land within the Nashville metropolitan area. As new housing and business projects pop up across the community, landowners are finding that now is a great time to sell. However, listing land traditionally can lead to delays, low offers, and long negotiations. Tennessee Cash For Homes offers a direct and simple solution — we buy land in Antioch for cash, allowing you to skip the lengthy listing process and get straight to closing.</p>
    ...
    <div class="land-section__form-wrap">
      <div class="hero__form-card">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="land-address-antioch">Property Address</label>
            <input type="text" id="land-address-antioch" name="address" placeholder="123 Acres Rd, Antioch, TN" required />
          </div>
          <div class="form-group">
            <label for="land-name-antioch">Your Name</label>
            <input type="text" id="land-name-antioch" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="land-phone-antioch">Phone Number</label>
            <input type="tel" id="land-phone-antioch" name="phone" placeholder="(615) 555-0123" required />
          </div>
          <button type="submit" class="btn-primary btn-primary--block">Get My Cash Offer &rarr;</button>
        </form>
        <p class="form-disclaimer">&#128274; Your info is private and never shared.</p>
...
<section class="cta-band">
  <div class="container">
    <h2>Ready to Sell Your Antioch House Fast for Cash?</h2>
