 ...
 * City location page for Knoxville, TN
 *
...
<!-- ── LOCATION HERO ── -->
<section class="location-hero" style="background-image: url('<?php echo get_template_directory_uri(); ?>/brand_assets/Where%20We%20Buy%20Pages/Where%20We%20Buy%20Images/Knoxville.webp');">
  ...
  <div class="container">
    <div class="location-hero__inner">
      <div class="location-hero__content">
        ...
        <div class="hero__badge">Knoxville Cash Home Buyers</div>
        <h1 class="location-hero__title">Sell Your House For Cash In Knoxville</h1>
        <p class="location-hero__subtitle">No repairs. No commissions. No fees. Get a fair cash offer for your Knoxville home in as little as 24 hours. We close on your timeline.</p>
      ...
      <div class="hero__form-card" id="get-offer">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="loc-address-knoxville">Property Address</label>
            <input type="text" id="loc-address-knoxville" name="address" placeholder="123 Main St, Knoxville, TN" required />
          </div>
          <div class="form-group">
            <label for="loc-name-knoxville">Your Name</label>
            <input type="text" id="loc-name-knoxville" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="loc-phone-knoxville">Phone Number</label>
            <input type="tel" id="loc-phone-knoxville" name="phone" placeholder="(615) 555-0123" required />
          </div>
  ...
  <div class="container">
    <div class="loc-about__inner">
      <div class="loc-about__content">
        <p class="section__eyebrow">We Buy Houses in Knoxville</p>
        <h2 class="section__title">Sell Your Knoxville House Fast for Cash</h2>
        <p class="loc-about__body">Nestled in the foothills of the Smoky Mountains, Knoxville is a beautiful city with a growing real estate market. Whether you're dealing with foreclosure, downsizing, or relocating, Tennessee Cash For Homes offers cash offers for homes in Knoxville that make the selling process easy. We buy homes in any condition, from older properties needing extensive repairs to newer homes in great shape. Our streamlined process allows you to sell quickly without the hassle of listing with an agent.</p>
        <p class="loc-about__body">Knoxville homeowners looking to sell quickly can rely on Tennessee Cash For Homes for a stress-free selling experience. We understand the local market and are prepared to make you an offer that allows you to sell your Knoxville home fast. Our team handles all aspects of the transaction, from the initial offer to closing, ensuring a smooth and efficient process. With no agent fees or commissions, you keep more of your money while still selling your home in a timely manner.</p>
        <a href="#get-offer" class="btn-primary">Get My Free Cash Offer &rarr;</a>
      </div>
...
<section class="land-section">
  ...
  <div class="container land-section__inner">
    <div class="land-section__content">
      <p class="section__eyebrow land-section__eyebrow">Knoxville Land Buyers</p>
      <h2 class="land-section__title">Sell Your Land in Knoxville for Cash</h2>
      <p class="land-section__body">Knoxville offers a unique blend of urban amenities and outdoor adventure, making land in and around the city highly desirable. Whether your property is near downtown, close to the Smoky Mountains, or in a growing suburban area, there's demand for land in Knoxville. However, selling land without the right connections can be a slow and frustrating process. Tennessee Cash For Homes provides a direct path to sell your Knoxville land for cash — fast, fair, and without agent fees or complicated paperwork.</p>
    ...
    <div class="land-section__form-wrap">
      <div class="hero__form-card">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="land-address-knoxville">Property Address</label>
            <input type="text" id="land-address-knoxville" name="address" placeholder="123 Acres Rd, Knoxville, TN" required />
          </div>
          <div class="form-group">
            <label for="land-name-knoxville">Your Name</label>
            <input type="text" id="land-name-knoxville" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="land-phone-knoxville">Phone Number</label>
            <input type="tel" id="land-phone-knoxville" name="phone" placeholder="(615) 555-0123" required />
          </div>
          <button type="submit" class="btn-primary btn-primary--block">Get My Cash Offer &rarr;</button>
        </form>
        <p class="form-disclaimer">&#128274; Your info is private and never shared.</p>
...
<section class="cta-band">
  <div class="container">
    <h2>Ready to Sell Your Knoxville House Fast for Cash?</h2>
