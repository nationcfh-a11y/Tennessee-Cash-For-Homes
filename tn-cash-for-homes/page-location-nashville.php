 ...
 * City location page for Nashville, TN
 *
...
<!-- ── LOCATION HERO ── -->
<section class="location-hero" style="background-image: url('<?php echo get_template_directory_uri(); ?>/brand_assets/Where%20We%20Buy%20Pages/Where%20We%20Buy%20Images/Nashville.webp');">
  ...
  <div class="container">
    <div class="location-hero__inner">
      <div class="location-hero__content">
        ...
        <div class="hero__badge">Nashville Cash Home Buyers</div>
        <h1 class="location-hero__title">Sell Your House For Cash In Nashville</h1>
        <p class="location-hero__subtitle">No repairs. No commissions. No fees. Get a fair cash offer for your Nashville home in as little as 24 hours. We close on your timeline.</p>
      ...
      <div class="hero__form-card" id="get-offer">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="loc-address-nashville">Property Address</label>
            <input type="text" id="loc-address-nashville" name="address" placeholder="123 Main St, Nashville, TN" required />
          </div>
          <div class="form-group">
            <label for="loc-name-nashville">Your Name</label>
            <input type="text" id="loc-name-nashville" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="loc-phone-nashville">Phone Number</label>
            <input type="tel" id="loc-phone-nashville" name="phone" placeholder="(615) 555-0123" required />
          </div>
  ...
  <div class="container">
    <div class="loc-about__inner">
      <div class="loc-about__content">
        <p class="section__eyebrow">We Buy Houses in Nashville</p>
        <h2 class="section__title">Sell Your Nashville House Fast for Cash</h2>
        <p class="loc-about__body">Nashville, known as "Music City," is a hotspot for those looking to sell their home quickly in a booming real estate market. If you need to sell your house in Nashville due to relocation, foreclosure, or simply wanting a fast, hassle-free sale, Tennessee Cash For Homes is your answer. We buy houses in Nashville in any condition, offering cash deals that skip the traditional market, saving you time and money on repairs and agent fees.</p>
        <p class="loc-about__body">In Nashville's dynamic market, our local experts understand the challenges you face when selling your home. Whether you're in the heart of downtown or the surrounding areas, Tennessee Cash For Homes delivers a seamless home-selling experience. We provide fair cash offers that reflect the market value of your Nashville property. Our team handles all aspects of the sale, from making the offer to managing closing, so you can focus on your next steps without worry.</p>
        <a href="#get-offer" class="btn-primary">Get My Free Cash Offer &rarr;</a>
      </div>
...
<section class="land-section">
  ...
  <div class="container land-section__inner">
    <div class="land-section__content">
      <p class="section__eyebrow land-section__eyebrow">Nashville Land Buyers</p>
      <h2 class="land-section__title">Sell Your Land in Nashville for Cash</h2>
      <p class="land-section__body">Nashville's booming economy and population growth have made land ownership more valuable than ever. However, zoning changes, development pressures, and property taxes are causing many owners to cash out now. Whether you own a lot in a developing neighborhood or acreage on the outskirts of the city, Tennessee Cash For Homes offers fast cash purchases for land in Nashville — no agents, no delays, and no uncertainty.</p>
    ...
    <div class="land-section__form-wrap">
      <div class="hero__form-card">
        ...
        <form onsubmit="handleSubmit(event)">
          <div class="form-group">
            <label for="land-address-nashville">Property Address</label>
            <input type="text" id="land-address-nashville" name="address" placeholder="123 Acres Rd, Nashville, TN" required />
          </div>
          <div class="form-group">
            <label for="land-name-nashville">Your Name</label>
            <input type="text" id="land-name-nashville" name="name" placeholder="John Smith" required />
          </div>
          <div class="form-group">
            <label for="land-phone-nashville">Phone Number</label>
            <input type="tel" id="land-phone-nashville" name="phone" placeholder="(615) 555-0123" required />
          </div>
          <button type="submit" class="btn-primary btn-primary--block">Get My Cash Offer &rarr;</button>
        </form>
        <p class="form-disclaimer">&#128274; Your info is private and never shared.</p>
...
<section class="cta-band">
  <div class="container">
    <h2>Ready to Sell Your Nashville House Fast for Cash?</h2>
